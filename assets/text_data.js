...
const instructions_polish = 'You have finished the practice task. You will now repeat the experiment on words instead of shapes. This time you will be presented with a word (in Danish) and must decide whether it is a real word or a nonsense word (i.e. string of letters with no meaning behind it). You must press the "w" key on your keyboard for a real word or the "n" key for a nonsense word. Press space to begin.'
